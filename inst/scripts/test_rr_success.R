...
upper_bound_10 <- list()
for (i in 1:5) {
  upper_bound_10[[i]] <- DAISIE::DAISIE_ML_CS(
...
upper_bound_100 <- list()
for (i in 1:5) {
  upper_bound_100[[i]] <- DAISIE::DAISIE_ML_CS(
    datalist = Galapagos_datalist,
    initparsopt = c(1, 1, 50, 0.1, 1, 0.1),
    idparsopt = 1:6,
    parsfix = NULL,
...
upper_bound_1000 <- list()
for (i in 1:5) {
  upper_bound_1000[[i]] <- DAISIE::DAISIE_ML_CS(
    datalist = Galapagos_datalist,
    initparsopt = c(1, 1, 50, 0.1, 1, 0.1),
    idparsopt = 1:6,
    parsfix = NULL,
...
upper_bound_inf <- list()
for (i in 1:5) {
  upper_bound_inf[[i]] <- DAISIE::DAISIE_ML_CS(
    datalist = Galapagos_datalist,
    initparsopt = c(1, 1, 50, 0.1, 1, 0.1),
    idparsopt = 1:6,
    parsfix = NULL,
